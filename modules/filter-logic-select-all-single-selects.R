...
columnFilterSelectAllSingleSelectUI <- function(id) {
  ns <- NS(id)
  uiOutput(ns("filter_container"))
}

columnFilterSelectAllSingleSelect <- function(input, output, session, df, 
...
columnFilterSelectAllSingleSelectSetUI <- function(id, column_indexes, column_width) {
  ns <- NS(id)
  lapply(as.list(column_indexes), function(i) {
    column(column_width,
           columnFilterSelectAllSingleSelectUI(ns(paste0("col", i)))
    )
  })
}

rowFilterSelectAllSingleSelectSetUI <- function(id, column_indexes) {
  ns <- NS(id)
  lapply(as.list(column_indexes), function(i) {
    columnFilterSelectAllSingleSelectUI(ns(paste0("col", i)))
  })
...
columnFilterSelectAllSingleSelectSet <- function(input, output, session, 
  ...
  filters <- lapply(column_indexes, function(i) {
    ...
    filter_values <- callModule(columnFilterSelectAllSingleSelect, paste0("col", i), df, i, 
